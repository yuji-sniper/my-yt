...
import type {
  ...
  GetVideoCategoriesHandlerInput
...
export type GetVideoCategoriesActionRequest = GetVideoCategoriesHandlerInput

export type GetVideoCategoriesActionResponse = ActionResponse<{
  items: GetVideoCategoriesResultItem[]
}>

export const getVideoCategoriesAction = async (
  request: GetVideoCategoriesActionRequest
): Promise<GetVideoCategoriesActionResponse> => {
